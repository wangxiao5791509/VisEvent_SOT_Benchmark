...
* [**SpikingJelly**] https://github.com/fangwei123456/spikingjelly (SpikingJelly is an open-source deep learning framework for Spiking Neural Network (SNN) based on PyTorch) 
