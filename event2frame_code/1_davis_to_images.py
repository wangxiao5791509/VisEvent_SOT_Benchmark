...
# def events_to_event_images(input_filename, output_file, output_filename, aps_frames_NUM, interval=0.005):
...
def _main(args):
    ...
    rawfile_path = "/media/wangxiao/PCL_Wang_Xiao_Disk1/event_data_collection/"
    files = os.listdir(rawfile_path) 
    
    
    
    savepath = "/media/wangxiao/PCL_Wang_Xiao_Disk1/output_/"
    ...
    for i in range(10):         
        ...
        davis_file = rawfile_path + sequence_names 
        ...
        aps_frames_NUM = len(os.listdir(output_aps_path))  
